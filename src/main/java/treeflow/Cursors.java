...
public class Cursors {
    ...
    public static final ImageCursor UP = new ImageCursor(
            new Image(Cursors.class.getResource("/cursors/up.png").toExternalForm()),
            255, 5);
    ...
    public static final ImageCursor DOWN = new ImageCursor(
            new Image(Cursors.class.getResource("/cursors/down.png").toExternalForm()),
            255, 506);
    ...
    public static final ImageCursor HORIZONTAL = new ImageCursor(
            new Image(Cursors.class.getResource("/cursors/horizontal.png").toExternalForm()),
            255, 255);
    public static final ImageCursor VERTICAL = new ImageCursor(
            new Image(Cursors.class.getResource("/cursors/vertical.png").toExternalForm()),
            255, 255);
}
